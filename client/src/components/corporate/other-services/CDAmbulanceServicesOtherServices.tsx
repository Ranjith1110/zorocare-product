...
const CDAmbulanceServicesOtherServices: FC<Props> = ({ onBack }) => {
    return (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-[13px] text-gray-500 font-medium mt-1">Manage emergency response, fleet tracking, and paramedical support.</p>
                    </div>
                </div>
            </div>
...
export default CDAmbulanceServicesOtherServices;