...
import {
    FiCalendar, FiCheckCircle, FiXCircle, FiArrowUpRight, FiClock,
    FiFilter, FiDownload, FiChevronDown, FiMoreVertical,
    FiActivity, FiMonitor, FiEye, FiBarChart2, FiUser, FiPhoneCall
} from 'react-icons/fi';
...
const CorporateHistoryCom: FC = () => {
    ...
    const utilizationRecords: UtilizationRecord[] = [
        {
            id: 'REC-01',
            user: { name: 'Priya Nair', email: 'pri***@company.com', phone: '+91 98765 43210', avatar: 'https://i.pravatar.cc/150?img=5' },
            corporate: { name: 'Engineering', id: 'DEP-125' },
        ...
        {
            id: 'REC-02',
            user: { name: 'Rahul Verma', email: 'ra***@company.com', phone: '+91 91234 56789', avatar: 'https://i.pravatar.cc/150?img=12' },
            corporate: { name: 'Sales & Marketing', id: 'DEP-126' },
        ...
        {
            id: 'REC-03',
            user: { name: 'Ananya Iyer', email: 'an***@company.com', phone: '+91 99876 54321', avatar: 'https://i.pravatar.cc/150?img=9' },
            corporate: { name: 'Human Resources', id: 'DEP-127' },
        ...
        {
            id: 'REC-04',
            user: { name: 'Sandeep Reddy', email: 'sa***@company.com', phone: '+91 90000 11122', avatar: 'https://i.pravatar.cc/150?img=14' },
            corporate: { name: 'Engineering', id: 'DEP-125' },
        ...
        {
            id: 'REC-05',
            user: { name: 'Meera Krishnan', email: 'me***@company.com', phone: '+91 93456 78901', avatar: 'https://i.pravatar.cc/150?img=1' },
            corporate: { name: 'Finance', id: 'DEP-128' },
        ...
        {
            id: 'REC-06',
            user: { name: 'Vikram Malhotra', email: 'vi***@company.com', phone: '+91 87654 32109', avatar: 'https://i.pravatar.cc/150?img=33' },
            corporate: { name: 'Engineering', id: 'DEP-125' },
    ...
    const topDepartments: TopDepartment[] = [
        { rank: 1, name: 'Engineering', id: 'DEP-125', utilizations: 612, trend: '18.7%', amountSpent: '₹24.18 Lakhs' },
        { rank: 2, name: 'Sales & Marketing', id: 'DEP-126', utilizations: 324, trend: '14.2%', amountSpent: '₹12.34 Lakhs' },
        { rank: 3, name: 'Human Resources', id: 'DEP-127', utilizations: 198, trend: '16.8%', amountSpent: '₹7.62 Lakhs' },
        { rank: 4, name: 'Finance', id: 'DEP-128', utilizations: 114, trend: '11.3%', amountSpent: '₹3.89 Lakhs' },
    ];
        ...
        <div className="w-full space-y-6 animate-in fade-in duration-500 pb-10">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
                <div>
                    ...
                    <p className="text-[13px] text-gray-500 font-medium mt-1">Track all employee utilizations, services and reports in one place.</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
                <div className="xl:col-span-8 bg-white rounded-md border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)] flex flex-col">
                    <div className="p-6 md:p-8 pb-4 border-b border-gray-50">
                        ...
                        <div className="flex flex-wrap lg:flex-nowrap items-center gap-3">
                            ...
                            <div className="flex items-center gap-2 bg-white border border-gray-200 px-3 py-1.5 rounded-md text-[12px] font-bold text-gray-700 w-full lg:w-auto hover:bg-gray-50 cursor-pointer">
                                All Departments <FiChevronDown className="w-3.5 h-3.5 ml-auto lg:ml-1" />
                            </div>
                            <div className="flex items-center gap-2 bg-white border border-gray-200 px-3 py-1.5 rounded-md text-[12px] font-bold text-gray-700 w-full lg:w-auto hover:bg-gray-50 cursor-pointer">
                            ...
                            <table className="w-full text-left border-collapse min-w-[1000px]">
                                <thead>
                                    <tr className="border-b border-gray-100 bg-gray-50/50">
                                        ...
                                        <th className="px-4 py-3 text-[11px] font-bold text-gray-500 uppercase tracking-wider">Department</th>
                ...
                <div className="xl:col-span-4 space-y-6">
                    ...
                    <div className="bg-white p-6 rounded-md border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)]">
                        <h3 className="font-bold text-gray-900 text-[16px] mb-5">Top Departments by Utilization</h3>
                                        ...
                                        <tr key={dept.id} className="hover:bg-gray-50/50 transition-colors group">
                                            <td className="py-4 whitespace-nowrap">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <p className="text-[12px] font-bold text-gray-900 group-hover:text-[#5301ab] transition-colors">{dept.name}</p>
                                                        <p className="text-[10px] text-gray-500 font-medium">{dept.id}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td className="py-4 whitespace-nowrap text-right">
                                                <p className="text-[13px] font-bold text-gray-900">{dept.utilizations}</p>
                                                <p className="text-[9px] text-emerald-500 font-bold flex items-center justify-end mt-0.5"><FiArrowUpRight /> {dept.trend}</p>
                                            </td>
                                            <td className="py-4 whitespace-nowrap text-[12px] font-bold text-gray-800 text-right">{dept.amountSpent}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
...
export default CorporateHistoryCom;