        ...
        <div className="w-full h-full animate-in fade-in duration-500 pb-10">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
                ...
                <div className="hidden xl:flex xl:col-span-2 flex-col gap-6 sticky top-24">
                        ...
                        <div className="flex flex-col space-y-1">
                            {sidebarLinks.map((link) => (
                                <button
                                    ...
                                    className={`flex items-center gap-3 px-4 py-3.5 rounded-[1.25rem] text-[13px] font-bold transition-all ${activeMenu === link.name
                    ...
                    {/* Promo Card: Track. Improve. Stay Healthy. */}
                    <div className="bg-gradient-to-br from-[#f8f9ff] to-purple-50 border border-purple-100/50 rounded-[2rem] p-6 text-center shadow-sm relative overflow-hidden flex flex-col items-center">
                    ...
                    {/* Need Help? */}
                    <div className="bg-white rounded-[2rem] border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)] p-6">
                ...
                <div className="xl:col-span-7 space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-3">
                        ...
                        <div className="flex items-center gap-2 bg-white border border-gray-200 px-4 py-2.5 rounded-xl shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] cursor-pointer hover:bg-gray-50 transition-colors">
                    ...
                    {/* REDESIGNED: Top Stats Grid - Fixed Congestion */}
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">

                        {/* Health Score - Spans 4 columns */}
                        <div className="lg:col-span-4 bg-white p-6 rounded-[2rem] border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)] flex flex-col items-center text-center h-full">
                            ...
                            <div className="bg-emerald-50 text-emerald-600 px-3 py-1.5 rounded-lg text-[10px] font-bold flex items-center gap-1 w-full justify-center">
                                <FiArrowUpRight className="w-3.5 h-3.5" /> 6 points <span className="text-emerald-600/70 font-medium">vs last month</span>
                            </div>
                        </div>

                        {/* Health Parameters - Spans 8 columns for much more space */}
                        <div className="lg:col-span-8 bg-white p-6 rounded-[2rem] border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)] flex flex-col h-full">
                                ...
                                {healthParameters.map((param, idx) => (
                                    <div key={idx} className="flex flex-col gap-2">
                                        <div className="flex items-center gap-2.5">
                                            <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${param.bg} ${param.color}`}>
                                                {param.icon}
                                            </div>
                                            <div>
                        ...
                        {/* Health Trend - Moved to Full Width row to eliminate congestion */}
                        <div className="lg:col-span-12 bg-white p-6 rounded-[2rem] border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)] flex flex-col">
                            <div className="flex items-center justify-between mb-4">
                                <h4 className="font-bold text-gray-900 text-[15px]">Health Trend</h4>
                                <button className="flex items-center gap-1 bg-gray-50 border border-gray-200 px-3 py-1.5 rounded-lg text-[11px] font-bold text-gray-600 hover:bg-gray-100 transition-colors">
                            ...
                            {/* Line Chart Mock SVG - Expanded Height */}
                            ...
                            <div className="bg-emerald-50/80 border border-emerald-100 rounded-xl p-3 flex items-center gap-3 mt-4 w-fit">
                    ...
                    {/* Health Reports (Horizontal Scroll) */}
                    <div>
                        ...
                        <div className="flex gap-4 overflow-x-auto pb-4 scroll-smooth [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                            {reports.map((report, idx) => (
                                <div key={idx} className="bg-white rounded-[1.5rem] border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)] p-5 min-w-[260px] shrink-0 flex flex-col hover:shadow-md transition-shadow">
                                    <div className="flex items-start gap-3 mb-4">
                                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${report.bg} ${report.color}`}>
                                            {report.icon}
                                        </div>
                                        <div>
                            ...
                            <div className="bg-gray-50 border border-gray-200 border-dashed rounded-[1.5rem] min-w-[50px] flex items-center justify-center cursor-pointer hover:bg-gray-100 transition-colors">
                                <FiChevronRight className="w-6 h-6 text-gray-400" />
                            </div>
                        </div>
                    </div>

                    {/* Bottom Row: Recent Checkups & Insights */}
                            ...
                            <div className="space-y-5">
                                {insights.map((insight, idx) => (
                                    <div key={idx} className="flex items-start gap-4">
                                        <div className={`w-10 h-10 rounded-2xl flex items-center justify-center shrink-0 ${insight.bg} ${insight.color}`}>
                                            {insight.icon}
                                        </div>
                                        <div>
                ...
                <div className="xl:col-span-3 space-y-6">
                    ...
                    <div className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)]">
                        ...
                        <div className="space-y-4">
                            {reminders.map((rem, idx) => (
                                <div key={idx} className="flex items-center justify-between gap-3 group cursor-pointer hover:bg-gray-50 p-2 -mx-2 rounded-xl transition-colors">
                                    <div className="flex items-center gap-3">
                                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${rem.bg} ${rem.color}`}>
                                            {rem.icon}
                                        </div>
                                        <div>
                    ...
                    <div className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)]">
                        ...
                        <div className="grid grid-cols-4 gap-3">
                            <div className="flex flex-col items-center text-center gap-2 cursor-pointer group">
                                <div className="w-12 h-12 rounded-[1rem] bg-[#5301ab]/5 text-[#5301ab] flex items-center justify-center group-hover:scale-110 transition-transform">
                                    <FiCalendar className="w-5 h-5" />
                                </div>
                                <span className="text-[10px] font-bold text-gray-600 leading-tight">Book<br />Checkup</span>
                            </div>
                            <div className="flex flex-col items-center text-center gap-2 cursor-pointer group">
                                <div className="w-12 h-12 rounded-[1rem] bg-blue-50 text-blue-500 flex items-center justify-center group-hover:scale-110 transition-transform">
                                    <FiFileText className="w-5 h-5" />
                                </div>
                                <span className="text-[10px] font-bold text-gray-600 leading-tight">View<br />Reports</span>
                            </div>
                            <div className="flex flex-col items-center text-center gap-2 cursor-pointer group">
                                <div className="w-12 h-12 rounded-[1rem] bg-emerald-50 text-emerald-500 flex items-center justify-center group-hover:scale-110 transition-transform">
                                    <FiTrendingUp className="w-5 h-5" />
                                </div>
                                <span className="text-[10px] font-bold text-gray-600 leading-tight">Track<br />Vitals</span>
                            </div>
                            <div className="flex flex-col items-center text-center gap-2 cursor-pointer group">
                                <div className="w-12 h-12 rounded-[1rem] bg-orange-50 text-orange-500 flex items-center justify-center group-hover:scale-110 transition-transform">
                    ...
                    <div className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)]">
                        ...
                        <div className="bg-emerald-50/50 border border-emerald-100 rounded-2xl p-5 relative overflow-hidden text-left">
                    ...
                    <div className="bg-gradient-to-br from-red-50 to-red-100/50 p-6 rounded-[2rem] border border-red-100 shadow-sm relative overflow-hidden text-left">
                        ...
                        {/* Decorative Ambulance Illustration */}
