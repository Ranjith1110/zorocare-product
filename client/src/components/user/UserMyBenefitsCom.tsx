    ...
    return (
        <div className="w-full space-y-6 animate-in fade-in duration-500 pb-10">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-6">
                <div>
                    <h2 className="font-heading text-2xl lg:text-[28px] font-bold text-gray-900 leading-tight mb-1">My Benefits</h2>
                    <p className="text-[13px] text-gray-500 font-medium">Explore your corporate health benefits and the services covered under your plan.</p>
                </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-5 items-start">
                                        ...
                                        {benefitsAtGlance.map((item, idx) => (
                                            <tr key={idx} className="hover:bg-gray-50/50 transition-colors">
                                                <td className="px-2 py-3 whitespace-nowrap">
                                                    <div className="flex items-center gap-3">
                                                        <div className={`w-8 h-8 rounded-md flex items-center justify-center ${item.bg} ${item.color}`}>
                                                            {item.icon}
                                                        </div>
                ...
                <div className="xl:col-span-4 space-y-5 flex flex-col">
                    ...
                    <div className="bg-white p-6 rounded-md border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)]">
                        ...
                        <div className="bg-orange-50/50 border border-orange-100 p-4 rounded-md flex items-start gap-3 mb-4">
                            <div className="w-8 h-8 bg-orange-100 text-orange-500 rounded-md flex items-center justify-center shrink-0">
                        ...
                        <div className="flex items-center justify-between p-3 rounded-md border border-gray-100 bg-gray-50/50">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 bg-white border border-gray-100 rounded-md flex items-center justify-center text-orange-500 shadow-sm">
                    ...
                    {/* Usage Trend */}
                    <div className="bg-white p-6 rounded-md border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)] flex-1 flex flex-col">
            ...
            <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5">
                    {coveredServices.map((service, idx) => (
                        <div key={idx} className="bg-white p-5 rounded-md border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)] flex flex-col hover:shadow-md transition-shadow group">
                            <div className="flex items-center justify-between mb-4">
                                <div className={`w-12 h-12 rounded-md flex items-center justify-center shrink-0 ${service.bg} ${service.color} group-hover:scale-110 transition-transform`}>
                                    {service.icon}
                                </div>
            ...
            {/* Support Banner */}
            <div className="bg-gradient-to-r from-purple-50 to-indigo-50 border border-purple-100 rounded-md p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm relative overflow-hidden">
                <div className="absolute -right-10 -top-10 w-40 h-40 bg-[#5301ab]/5 rounded-full blur-2xl z-0"></div>
                <div className="flex items-center gap-5 relative z-10">
                    <div className="w-14 h-14 bg-white text-[#5301ab] rounded-md flex items-center justify-center shrink-0 shadow-sm border border-purple-100">
