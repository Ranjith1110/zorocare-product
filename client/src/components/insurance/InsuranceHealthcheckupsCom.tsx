...
const InsuranceHealthcheckupsCom: FC = () => {
    ...
    const sponsoredCheckups: CheckupCard[] = [
        {
            ...
            description: 'Essential tests to assess your overall health and fitness.',
        ...
        },
        {
            ...
            description: 'Advanced tests to evaluate your heart health.',
        ...
        },
        {
            ...
            description: 'Monitor your blood sugar and diabetes related parameters.',
        ...
        },
        {
            ...
            description: 'Complete body checkup for your overall wellness.',
    ...
    const paidCheckups: CheckupCard[] = [
        ...
        },
        {
            ...
            description: 'In-depth evaluation of your heart health.',
        ...
        },
        {
            ...
            description: 'Assess your lung health and respiratory wellness.',
        ...
        },
        {
            ...
            description: 'Evaluate your digestive system and related parameters.',
    ...
    const howItWorksSteps: Step[] = [
        { id: '01', title: 'Check eligible checkups', description: 'sponsored for you.', icon: <FiFileText className="w-4 h-4" /> },
        { id: '02', title: 'Select a date & preferred', description: 'lab/center.', icon: <FiCalendar className="w-4 h-4" /> },
        { id: '03', title: 'Book your health checkup', description: 'easily.', icon: <FiCheckCircle className="w-4 h-4" /> },
        { id: '04', title: 'Visit the center and get', description: 'your tests done.', icon: <FiActivity className="w-4 h-4" /> },
        { id: '05', title: 'Receive your reports', description: 'digitally.', icon: <FiDroplet className="w-4 h-4" /> },
    ];
        ...
        <div className="w-full space-y-6 animate-in fade-in duration-500 pb-10">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
                <div>
                    ...
                    <p className="text-[13px] text-gray-500 font-medium mt-1">Choose from a wide range of health checkups to keep you and your family healthy.</p>
                </div>
            </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 border-b border-gray-50 pb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[12px] text-gray-500 font-medium mt-0.5">Health checkups sponsored by your employer or insurance partner.</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 border-b border-gray-50 pb-6">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[12px] text-gray-500 font-medium mt-0.5">Book premium health checkups with best prices and offers.</p>
                        </div>
                    </div>
                    <div className="hidden sm:flex items-center gap-2 bg-gray-50 border border-gray-100 px-3 py-2 rounded-md">
...
export default InsuranceHealthcheckupsCom;