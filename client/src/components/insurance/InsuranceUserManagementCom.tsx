...
interface UserDirectoryEntry {
    id: string; internalId: string; name: string; avatar: string; role: string; roleColor: string; roleBg: string; organization: string; email: string; phone: string; status: 'Active' | 'Inactive' | 'Pending' | 'Blocked'; lastActiveDate: string; lastActiveTime: string; joinedOn: string;
}
...
const InsuranceUserManagementCom: FC = () => {
    const [searchQuery, setSearchQuery] = useState('');

    const topKPIs: KPI[] = [
        { title: 'Total Users', value: '12,560', trend: '15.3%', isPositive: true, icon: <FiUsers className="w-6 h-6" />, color: 'text-[#5301ab]', bg: 'bg-[#5301ab]/10' },
        { title: 'Active Users', value: '9,845', trend: '12.8%', isPositive: true, icon: <FiShield className="w-6 h-6" />, color: 'text-emerald-500', bg: 'bg-emerald-50' },
        { title: 'Inactive Users', value: '1,245', trend: '4.6%', isPositive: false, icon: <FiUserMinus className="w-6 h-6" />, color: 'text-orange-500', bg: 'bg-orange-50' },
    ...
    const overviewKPIs: KPI[] = [
        { title: 'New Users', value: '78', trend: '18.2%', isPositive: true, icon: <FiUserPlus />, color: 'text-[#5301ab]', bg: 'bg-[#5301ab]/10' },
        { title: 'Active Users', value: '9,845', trend: '12.8%', isPositive: true, icon: <FiShield />, color: 'text-emerald-500', bg: 'bg-emerald-50' },
        { title: 'Deactivated Users', value: '23', trend: '8.9%', isPositive: false, icon: <FiUserMinus />, color: 'text-orange-500', bg: 'bg-orange-50' },
        { title: 'Blocked Users', value: '12', trend: '14.3%', isPositive: false, icon: <FiLock />, color: 'text-red-500', bg: 'bg-red-50' },
    ];

    const usersDirectory: UserDirectoryEntry[] = [
        { id: '1', internalId: 'ID: USR1001', name: 'Ramesh Kumar', avatar: 'https://i.pravatar.cc/150?img=11', role: 'Corporate Admin', roleColor: 'text-[#5301ab]', roleBg: 'bg-[#5301ab]/10', organization: 'TechNova Solutions', email: 'ramesh.kumar@technova.com', phone: '+91 98765 43210', status: 'Active', lastActiveDate: '18 May 2026', lastActiveTime: '10:45 AM', joinedOn: '15 Jan 2026' },
        { id: '2', internalId: 'ID: USR1002', name: 'Sunita Sharma', avatar: 'https://i.pravatar.cc/150?img=5', role: 'Broker / Sales', roleColor: 'text-blue-600', roleBg: 'bg-blue-50', organization: 'Global Infotech', email: 'sunita.sharma@globalinfotech.com', phone: '+91 91234 56789', status: 'Active', lastActiveDate: '18 May 2026', lastActiveTime: '09:30 AM', joinedOn: '20 Jan 2026' },
        { id: '3', internalId: 'ID: USR1003', name: 'Anil Verma', avatar: 'https://i.pravatar.cc/150?img=12', role: 'Employee', roleColor: 'text-orange-600', roleBg: 'bg-orange-50', organization: 'HealthPlus Systems', email: 'anil.verma@healthplus.com', phone: '+91 99887 66554', status: 'Active', lastActiveDate: '17 May 2026', lastActiveTime: '07:15 PM', joinedOn: '02 Feb 2026' },
        { id: '4', internalId: 'ID: USR1004', name: 'Priya Menon', avatar: 'https://i.pravatar.cc/150?img=9', role: 'Partner', roleColor: 'text-emerald-600', roleBg: 'bg-emerald-50', organization: 'Future Enterprises', email: 'priya.menon@futureent.com', phone: '+91 97654 32109', status: 'Inactive', lastActiveDate: '10 May 2026', lastActiveTime: '04:20 PM', joinedOn: '11 Mar 2026' },
        { id: '5', internalId: 'ID: USR1005', name: 'Vikram Singh', avatar: 'https://i.pravatar.cc/150?img=14', role: 'Broker / Sales', roleColor: 'text-blue-600', roleBg: 'bg-blue-50', organization: 'BrightMind Pvt Ltd', email: 'vikram.singh@brightmind.com', phone: '+91 93456 78901', status: 'Active', lastActiveDate: '18 May 2026', lastActiveTime: '11:05 AM', joinedOn: '05 Apr 2026' },
        { id: '6', internalId: 'ID: USR1006', name: 'Meera Patel', avatar: 'https://i.pravatar.cc/150?img=1', role: 'Customer', roleColor: 'text-pink-600', roleBg: 'bg-pink-50', organization: '-', email: 'meera.patel@gmail.com', phone: '+91 90000 11122', status: 'Pending', lastActiveDate: '-', lastActiveTime: '', joinedOn: '18 May 2026' },
    ];

    const userActivities: ActivityEntry[] = [
        { label: 'Logins', value: '2,845', trend: '16.3%', isPositive: true, icon: <FiShield />, color: 'text-blue-500', bg: 'bg-blue-50' },
        { label: 'Profile Updates', value: '452', trend: '12.8%', isPositive: true, icon: <FiUsers />, color: 'text-emerald-500', bg: 'bg-emerald-50' },
        { label: 'Password Changes', value: '128', trend: '6.2%', isPositive: false, icon: <FiLock />, color: 'text-orange-500', bg: 'bg-orange-50' },
        { label: 'New User Registrations', value: '78', trend: '18.2%', isPositive: true, icon: <FiUserPlus />, color: 'text-[#5301ab]', bg: 'bg-[#5301ab]/10' },
        { label: 'Users Deactivated', value: '23', trend: '8.9%', isPositive: false, icon: <FiUserX />, color: 'text-red-500', bg: 'bg-red-50' },
    ];

    const quickActions: QuickAction[] = [
        { title: 'Add New User', desc: 'Create a new user account', icon: <FiUsers />, color: 'text-[#5301ab]', bg: 'bg-[#5301ab]/10', actionIcon: <FiPlus /> },
        { title: 'Import Users', desc: 'Upload users in bulk via CSV', icon: <FiUpload />, color: 'text-[#5301ab]', bg: 'bg-[#5301ab]/10', actionIcon: <FiUpload /> },
        { title: 'Roles & Permissions', desc: 'Manage roles and access', icon: <FiShield />, color: 'text-[#5301ab]', bg: 'bg-[#5301ab]/10', actionIcon: <FiShield /> },
        { title: 'User Activity Log', desc: 'View all user activities', icon: <FiList />, color: 'text-[#5301ab]', bg: 'bg-[#5301ab]/10', actionIcon: <FiList /> },
    ];
        ...
        <div className="w-full space-y-6 animate-in fade-in duration-500 pb-10">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
                <div>
                    ...
                    <p className="text-[13px] text-gray-500 font-medium mt-1">Manage platform users, roles, permissions and activity.</p>
                </div>
            </div>
                    ...
                    <div className="flex flex-col items-center justify-center relative">
                        <div className="relative w-40 h-40 mb-6">
                            <svg className="w-full h-full transform -rotate-90 drop-shadow-sm" viewBox="0 0 36 36">
                                ...
                                <path className="text-blue-500" strokeDasharray="32.8, 100" strokeDashoffset="-19.5" strokeWidth="5" strokeLinecap="butt" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                                <path className="text-orange-500" strokeDasharray="25.8, 100" strokeDashoffset="-52.3" strokeWidth="5" strokeLinecap="butt" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                                <path className="text-emerald-500" strokeDasharray="9.9, 100" strokeDashoffset="-78.1" strokeWidth="5" strokeLinecap="butt" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                                <path className="text-gray-400" strokeDasharray="11.9, 100" strokeDashoffset="-88" strokeWidth="5" strokeLinecap="butt" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                            </svg>
                        ...
                        <div className="w-full space-y-2.5 px-2">
                            <div className="flex items-center justify-between text-[11px]"><div className="flex items-center gap-2"><span className="w-2.5 h-2.5 rounded-full bg-[#5301ab]"></span><span className="font-bold text-gray-600">Corporate Admin</span></div><span className="font-bold text-gray-900">2,450 <span className="text-gray-400 font-medium">(19.5%)</span></span></div>
                            <div className="flex items-center justify-between text-[11px]"><div className="flex items-center gap-2"><span className="w-2.5 h-2.5 rounded-full bg-blue-500"></span><span className="font-bold text-gray-600">Broker / Sales</span></div><span className="font-bold text-gray-900">4,120 <span className="text-gray-400 font-medium">(32.8%)</span></span></div>
                            <div className="flex items-center justify-between text-[11px]"><div className="flex items-center gap-2"><span className="w-2.5 h-2.5 rounded-full bg-orange-500"></span><span className="font-bold text-gray-600">Employee</span></div><span className="font-bold text-gray-900">3,245 <span className="text-gray-400 font-medium">(25.8%)</span></span></div>
                            <div className="flex items-center justify-between text-[11px]"><div className="flex items-center gap-2"><span className="w-2.5 h-2.5 rounded-full bg-emerald-500"></span><span className="font-bold text-gray-600">Partner</span></div><span className="font-bold text-gray-900">1,245 <span className="text-gray-400 font-medium">(9.9%)</span></span></div>
                            <div className="flex items-center justify-between text-[11px]"><div className="flex items-center gap-2"><span className="w-2.5 h-2.5 rounded-full bg-gray-400"></span><span className="font-bold text-gray-600">Customer</span></div><span className="font-bold text-gray-900">1,500 <span className="text-gray-400 font-medium">(11.9%)</span></span></div>
                        </div>
                    </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
                <div className="xl:col-span-8 bg-white rounded-md border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)] p-6 md:p-8">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                        <h3 className="font-bold text-gray-900 text-[18px]">Users Directory</h3>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3 mb-6">
                        <div className="lg:col-span-2 flex items-center gap-2 bg-gray-50 border border-gray-200 px-3 py-2 rounded-md focus-within:border-[#5301ab]/50 transition-colors">
                            ...
                            <input type="text" placeholder="Search by name, email or phone..." className="bg-transparent border-none outline-none text-[12px] w-full placeholder-gray-400" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
                        </div>
                        ...
                        <table className="w-full text-left border-collapse min-w-[900px]">
                            <thead>
                                <tr className="border-b border-gray-100">
                                    ...
                                    <th className="pb-3 text-[11px] font-bold text-gray-400 uppercase tracking-wider">Corporate / Organization</th>
                            ...
                            <tbody className="divide-y divide-gray-50">
                                {usersDirectory.map((user) => (
                                    <tr key={user.id} className="hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td className="py-4 whitespace-nowrap text-[12px] font-bold text-gray-800">{user.organization}</td>
                                        <td className="py-4 whitespace-nowrap">
                    ...
                    <div className="flex items-center justify-between mt-6 pt-4 border-t border-gray-50">
                        <p className="text-[12px] font-medium text-gray-500">Showing 1 to 10 of 156 users</p>
                ...
                <div className="xl:col-span-4 space-y-6">
                    <div className="bg-white p-6 rounded-md border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)]">
                        <div className="flex items-center justify-between mb-6">
                            <h3 className="font-bold text-gray-900 text-[16px]">User Activity</h3>
...
export default InsuranceUserManagementCom;