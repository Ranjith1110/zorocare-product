...
import {
    ...
    FiFileText, FiPhoneCall, FiGrid, FiHeart, FiLock, FiAward, FiMapPin, FiUsers,
    FiArrowRight
} from 'react-icons/fi';
...
const IDCareProgramsOtherServices: FC<Props> = ({ onBack }) => {
...
export default IDCareProgramsOtherServices;