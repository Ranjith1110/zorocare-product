...
import {
    ...
    FiFileText, FiPhoneCall, FiGrid, FiHeart, FiMoon, FiLock, FiHeadphones, FiAward
} from 'react-icons/fi';
...
const IDWellnessServicesOtherServices: FC<Props> = ({ onBack }) => {
    ...
    const trustMarkers = [
        { title: 'Certified Experts', desc: 'Experienced & verified wellness professionals', icon: <FiCheckCircle className="text-[#5301ab] w-5 h-5" />, bg: 'bg-[#5301ab]/10' },
        { title: 'Safe & Secure', desc: 'Your health data is always protected', icon: <FiLock className="text-emerald-500 w-5 h-5" />, bg: 'bg-emerald-50' },
        { title: 'Easy Booking', desc: 'Quick and hassle-free booking process', icon: <FiCalendar className="text-blue-500 w-5 h-5" />, bg: 'bg-blue-50' },
        { title: '24x7 Support', desc: 'We are here to help you anytime', icon: <FiHeadphones className="text-[#5301ab] w-5 h-5" />, bg: 'bg-[#5301ab]/10' },
    ];
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-[13px] text-gray-500 font-medium mt-1">Holistic wellness programs to help you achieve a healthier mind, body and lifestyle.</p>
                    </div>
                </div>
            </div>
                        ...
                        <div className="relative">
                            ...
                            <div className="space-y-6 relative z-10">
                                {bookingSteps.map((step, idx) => {
                                    // Assign specific colors to steps matching reference
                                    const stepColors = [
...
export default IDWellnessServicesOtherServices;