...
const InsuranceSponsoredServicesCom: FC = () => {
    ...
    const topKPIs: KPI[] = [
        ...
        { title: 'Amount Sponsored', value: '₹24.8 Lakhs', trend: '14.3%', isPositive: true, icon: <span className="font-bold text-xl">₹</span>, color: 'text-red-500', bg: 'bg-red-50' },
        { title: 'Active Sponsored', value: '56', trend: '12.2%', isPositive: true, icon: <FiUser className="w-6 h-6" />, color: 'text-blue-500', bg: 'bg-blue-50' },
    ];
        ...
        <div className="w-full space-y-6 animate-in fade-in duration-500 pb-10">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
                <div>
                    ...
                    <p className="text-[13px] text-gray-500 font-medium mt-1">Explore and book sponsored healthcare services for your employees and their dependents.</p>
                </div>
            </div>
...
export default InsuranceSponsoredServicesCom;