...
const InsuranceDasboardCom: FC = () => {

    const topKPIs: KPI[] = [
        { title: 'Total Revenue', value: '₹24.8 Lakhs', trend: '18.4%', isPositive: true, icon: <span className="font-bold text-xl">₹</span>, color: 'text-[#5301ab]', bg: 'bg-[#5301ab]/10' },
        { title: 'Active Policies', value: '12,560', trend: '12.6%', isPositive: true, icon: <FiShield className="w-6 h-6" />, color: 'text-emerald-500', bg: 'bg-emerald-50' },
        { title: 'Total Users', value: '8,945', trend: '15.3%', isPositive: true, icon: <FiUsers className="w-6 h-6" />, color: 'text-blue-500', bg: 'bg-blue-50' },
        { title: 'Healthcheckups', value: '3,245', trend: '20.1%', isPositive: true, icon: <FiActivity className="w-6 h-6" />, color: 'text-[#e11d48]', bg: 'bg-rose-50' },
        { title: 'Claims Processed', value: '1,256', trend: '14.7%', isPositive: true, icon: <FiFileText className="w-6 h-6" />, color: 'text-orange-500', bg: 'bg-orange-50' },
        { title: 'Pending Claims', value: '98', trend: '8.2%', isPositive: false, icon: <FiActivity className="w-6 h-6" />, color: 'text-red-500', bg: 'bg-red-50' },
    ];

    const progressGoals = [
        { title: 'Policies Issued', percent: 65, color: 'bg-[#5301ab]' },
        { title: 'Renewals', percent: 48, color: 'bg-[#fd5800]' },
        { title: 'Healthcheckups Goal', percent: 72, color: 'bg-[#5301ab]' },
        { title: 'Claims Turnaround', percent: 35, color: 'bg-[#fd5800]' },
        { title: 'Revenue Target', percent: 58, color: 'bg-[#5301ab]' },
    ];

    const activities: Activity[] = [
        { action: 'New policy created for', subject: 'TechNova Solutions', time: '2 mins ago', icon: <FiFileText />, color: 'text-blue-500', bg: 'bg-blue-50' },
        { action: 'Health checkup booked for', subject: 'Ramesh Kumar', time: '15 mins ago', icon: <FiActivity />, color: 'text-rose-500', bg: 'bg-rose-50' },
        { action: 'Claim approved for', subject: 'Sunita Sharma', time: '1 hour ago', icon: <FiFileText />, color: 'text-emerald-500', bg: 'bg-emerald-50' },
        { action: 'Corporate package renewed for', subject: 'Global Infotech', time: '2 hours ago', icon: <TbBuildingCommunity />, color: 'text-[#5301ab]', bg: 'bg-[#5301ab]/10' },
        { action: 'New user registered', subject: 'Amit Verma', time: '3 hours ago', icon: <FiUsers />, color: 'text-[#5301ab]', bg: 'bg-[#5301ab]/10' },
    ];
        ...
        <div className="w-full space-y-6 animate-in fade-in duration-500 pb-10">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-5">
                <div>
                    ...
                    <p className="text-[14px] text-gray-500 font-medium">Here's what's happening with your insurance business today.</p>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-4 sm:gap-8 self-start lg:self-auto">
                    <div className="flex items-center gap-3 bg-white p-3 rounded-md border border-gray-100 shadow-sm lg:border-none lg:shadow-none lg:bg-transparent lg:p-0">
                        ...
                        <div>
                            <p className="text-[18px] sm:text-[20px] font-bold text-gray-900 font-heading leading-none">124</p>
                            <p className="text-[10px] font-bold text-gray-500 uppercase tracking-wider mt-0.5">Corporates</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-3 bg-white p-3 rounded-md border border-gray-100 shadow-sm lg:border-none lg:shadow-none lg:bg-transparent lg:p-0">
                        <FiUsers className="w-6 h-6 text-blue-500 lg:text-gray-400" />
                        <div>
                            <p className="text-[18px] sm:text-[20px] font-bold text-gray-900 font-heading leading-none">8,945</p>
                            <p className="text-[10px] font-bold text-gray-500 uppercase tracking-wider mt-0.5">Users</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-3 bg-white p-3 rounded-md border border-gray-100 shadow-sm lg:border-none lg:shadow-none lg:bg-transparent lg:p-0">
                        <FiFileText className="w-6 h-6 text-emerald-500 lg:text-gray-400" />
                        <div>
                            <p className="text-[18px] sm:text-[20px] font-bold text-gray-900 font-heading leading-none">315</p>
                            <p className="text-[10px] font-bold text-gray-500 uppercase tracking-wider mt-0.5">Policies Issued</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-5 bg-white p-6 rounded-md border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)] flex flex-col">
                    <div className="flex items-center justify-between mb-6">
                        <h3 className="font-bold text-gray-900 text-[16px]">Business Overview</h3>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                        <div className="text-center p-3 bg-gray-50/50 rounded-md border border-gray-100">
                            ...
                            <p className="text-[10px] text-gray-500 font-bold mb-0.5">New Policies</p>
                            <p className="text-[14px] font-bold text-gray-900">1,845</p>
                        ...
                        <div className="text-center p-3 bg-gray-50/50 rounded-md border border-gray-100">
                            ...
                            <p className="text-[10px] text-gray-500 font-bold mb-0.5">Renewals</p>
                            <p className="text-[14px] font-bold text-gray-900">2,654</p>
                        ...
                        <div className="text-center p-3 bg-gray-50/50 rounded-md border border-gray-100">
                            ...
                            <p className="text-[10px] text-gray-500 font-bold mb-0.5">Conversions</p>
                        ...
                        <div className="text-center p-3 bg-gray-50/50 rounded-md border border-gray-100">
                            ...
                            <p className="text-[10px] text-gray-500 font-bold mb-0.5">Avg. Value</p>
                            <p className="text-[14px] font-bold text-gray-900">₹18,560</p>
                ...
                <div className="xl:col-span-3 bg-white p-6 rounded-md border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)] flex flex-col items-center justify-center relative">
                    <div className="w-full flex justify-start mb-2 lg:absolute lg:top-6 lg:left-6">
                        <h3 className="font-bold text-gray-900 text-[16px]">Policies by Category</h3>
                    </div>
                    ...
                    <div className="relative w-44 h-44 mt-4 lg:mt-8 mb-6">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                            ...
                            <p className="text-[10px] font-bold text-gray-400 uppercase">Total Policies</p>
                        </div>
                    </div>

                    <div className="w-full space-y-2 px-2">
                        <div className="flex items-center justify-between text-[11px] font-bold"><div className="flex items-center gap-2"><span className="w-2.5 h-2.5 rounded-full bg-[#5301ab]"></span><span className="text-gray-600">Health Insurance</span></div><span className="text-gray-900">45%</span></div>
                        <div className="flex items-center justify-between text-[11px] font-bold"><div className="flex items-center gap-2"><span className="w-2.5 h-2.5 rounded-full bg-blue-500"></span><span className="text-gray-600">Life Insurance</span></div><span className="text-gray-900">25%</span></div>
                        <div className="flex items-center justify-between text-[11px] font-bold"><div className="flex items-center gap-2"><span className="w-2.5 h-2.5 rounded-full bg-orange-500"></span><span className="text-gray-600">Motor Insurance</span></div><span className="text-gray-900">15%</span></div>
                        <div className="flex items-center justify-between text-[11px] font-bold"><div className="flex items-center gap-2"><span className="w-2.5 h-2.5 rounded-full bg-emerald-500"></span><span className="text-gray-600">Travel Insurance</span></div><span className="text-gray-900">8%</span></div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-4 bg-white rounded-md border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)] overflow-hidden">
                    <div className="p-5 border-b border-gray-50 flex items-center justify-between">
                        <h3 className="font-bold text-gray-900 text-[15px]">Top Corporates</h3>
                        <a href="#" className="text-[11px] font-bold text-[#5301ab] hover:underline">View All</a>
                    </div>
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-gray-50/50 border-b border-gray-100">
                                <th className="px-5 py-3 text-[10px] font-bold text-gray-500 uppercase tracking-wider">Company Name</th>
                                <th className="px-5 py-3 text-[10px] font-bold text-gray-500 uppercase tracking-wider text-center">Policies</th>
                                <th className="px-5 py-3 text-[10px] font-bold text-gray-500 uppercase tracking-wider text-center">Members</th>
                                <th className="px-5 py-3 text-[10px] font-bold text-gray-500 uppercase tracking-wider text-right">Revenue</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-50">
                            {[1, 2, 3].map((_, i) => (
                                <tr key={i} className="hover:bg-gray-50/50">
                                    <td className="px-5 py-3.5 text-[11px] font-bold text-gray-800">TechNova Solutions</td>
                                    <td className="px-5 py-3.5 text-[11px] font-bold text-gray-800 text-center">1,245</td>
                                    <td className="px-5 py-3.5 text-[11px] font-bold text-gray-800 text-center">3,560</td>
                ...
                <div className="xl:col-span-5 bg-white rounded-md border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)] overflow-hidden">
                    <div className="p-5 border-b border-gray-50 flex items-center justify-between">
                        <h3 className="font-bold text-gray-900 text-[15px]">Recent Policies</h3>
                        <a href="#" className="text-[11px] font-bold text-[#5301ab] hover:underline">View All</a>
                    </div>
                    <div className="w-full overflow-x-auto [&::-webkit-scrollbar]:hidden">
                        <table className="w-full text-left border-collapse min-w-[500px]">
                            <thead>
                                <tr className="bg-gray-50/50 border-b border-gray-100">
                                    <th className="px-5 py-3 text-[10px] font-bold text-gray-500 uppercase tracking-wider">Policy No.</th>
                                    <th className="px-5 py-3 text-[10px] font-bold text-gray-500 uppercase tracking-wider">Corporate Name</th>
                                    <th className="px-5 py-3 text-[10px] font-bold text-gray-500 uppercase tracking-wider">Policy Type</th>
                            ...
                            <tbody className="divide-y divide-gray-50">
                                {[1, 2, 3].map((_, i) => (
                                    <tr key={i} className="hover:bg-gray-50/50">
                                        <td className="px-5 py-3.5 text-[11px] font-bold text-gray-500">POL-2026-1250</td>
                                        <td className="px-5 py-3.5 text-[11px] font-bold text-gray-800">TechNova Solutions</td>
                                        <td className="px-5 py-3.5 text-[11px] font-bold text-gray-700">Health Insurance</td>
                ...
                {/* Revenue Overview (Bar Chart Mock) */}
                <div className="xl:col-span-3 bg-white p-6 rounded-md border border-gray-100 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.03)] flex flex-col">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="font-bold text-gray-900 text-[15px]">Revenue Overview</h3>
                    ...
                    <div className="mb-4">
                        <h2 className="font-heading text-[22px] font-bold text-gray-900 leading-none">₹24.8 Lakhs</h2>
...
export default InsuranceDasboardCom;