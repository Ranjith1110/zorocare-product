...
import AdminManageServiceDetails from './AdminManageServiceDetails';
    ...
    return (
        <div className="w-full space-y-6 animate-in fade-in duration-500 pb-10">
            ...
            {viewMode === 'manage' && activeService && (
                <AdminManageServiceDetails service={activeService} />
            )}
...
export default AdminServiceHubCom;